...
def PairConvLSTMModel(batch_size, image_size, sequence_length, num_classes=3):
    ...
    full_features = SingleConvLSTMModel(batch_size, image_size, sequence_length//2)(full_inp)
    cutout_features = SingleConvLSTMModel(batch_size, image_size, sequence_length//2)(cutout_inp)
